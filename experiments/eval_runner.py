...
Batch evaluation runner for SmolVLA pick-and-place across EE position shift
conditions. Results are appended to experiments/results.csv after every episode.
...
The viewer window must be open — rendering is not headless.
"""
