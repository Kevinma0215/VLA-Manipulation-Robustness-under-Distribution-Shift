"""
experiments/make_grid_gif.py

Creates a 4×3 GIF grid from experiment result videos.
Columns = conditions (nominal / mild / medium / strong)
Rows    = 3 seeds, chosen per condition below

──────────────────────────────────────────────────
CONFIGURE SEEDS HERE
──────────────────────────────────────────────────
Edit SEED_SELECTION to pick which 3 seeds to show
for each condition.  Use zero-padded strings ("00"–"19").
"""
